...
def token_test(
    ...
    assert (roles == expected_role) or (
                expected_role in roles), f"{token_field} error for user {user}, field {roles_field} has an incorrect value, expected {expected_role}, got {roles}."
...
def user_token_test(is_customer, response, token_field, secret, expected_type, roles_field, expected_role,
                    expected_expires_delta):
    token_test(
        response=response,
...
def run_authentication_tests(authentication_url, jwt_secret, roles_field, customer_role, courier_role, owner_role):
    ...
    tests = [
        ...
        ["post", authentication_url + "/register_customer", set_up_pass_function, {}, {}, {}, 400,
         {"message": "Field forename is missing."}, equals, 1],
        ["post", authentication_url + "/register_customer", set_up_pass_function, {}, {"forename": ""}, {}, 400,
         {"message": "Field forename is missing."}, equals, 1],
        ["post", authentication_url + "/register_customer", set_up_pass_function, {}, {"forename": " "}, {}, 400,
         {"message": "Field surname is missing."}, equals, 1],
        ["post", authentication_url + "/register_customer", set_up_pass_function, {}, {"forename": " ", "surname": ""},
         {}, 400, {"message": "Field surname is missing."}, equals, 1],
        ["post", authentication_url + "/register_customer", set_up_pass_function, {}, {"forename": " ", "surname": " "},
         {}, 400, {"message": "Field email is missing."}, equals, 1],
        ["post", authentication_url + "/register_customer", set_up_pass_function, {},
         {"forename": " ", "surname": " ", "email": ""}, {}, 400, {"message": "Field email is missing."}, equals, 1],
        ["post", authentication_url + "/register_customer", set_up_pass_function, {},
         {"forename": " ", "surname": " ", "email": " "}, {}, 400, {"message": "Field password is missing."}, equals,
         1],
        ["post", authentication_url + "/register_customer", set_up_pass_function, {},
         {"forename": " ", "surname": " ", "email": " ", "password": ""}, {}, 400,
         {"message": "Field password is missing."}, equals, 1],
        ["post", authentication_url + "/register_customer", set_up_pass_function, {},
         {"forename": "John", "surname": "Doe", "email": " ", "password": " "}, {}, 400, {"message": "Invalid email."},
         equals, 1],
        ["post", authentication_url + "/register_customer", set_up_pass_function, {},
         {"forename": "John", "surname": "Doe", "email": "john", "password": " "}, {}, 400,
         {"message": "Invalid email."}, equals, 1],
        ["post", authentication_url + "/register_customer", set_up_pass_function, {},
         {"forename": "John", "surname": "Doe", "email": "john@", "password": " "}, {}, 400,
         {"message": "Invalid email."}, equals, 1],
        ["post", authentication_url + "/register_customer", set_up_pass_function, {},
         {"forename": "John", "surname": "Doe", "email": "john@gmail", "password": " "}, {}, 400,
         {"message": "Invalid email."}, equals, 1],
        ["post", authentication_url + "/register_customer", set_up_pass_function, {},
         {"forename": "John", "surname": "Doe", "email": "john@gmail.", "password": " "}, {}, 400,
         {"message": "Invalid email."}, equals, 1],
        ["post", authentication_url + "/register_customer", set_up_pass_function, {},
         {"forename": "John", "surname": "Doe", "email": "john@gmail.a", "password": " "}, {}, 400,
         {"message": "Invalid email."}, equals, 1],
        ["post", authentication_url + "/register_customer", set_up_pass_function, {},
         {"forename": "John", "surname": "Doe", "email": "john@gmail.com", "password": " "}, {}, 400,
         {"message": "Invalid password."}, equals, 1],
        ["post", authentication_url + "/register_customer", set_up_pass_function, {},
         {"forename": "John", "surname": "Doe", "email": "john@gmail.com", "password": "aaaa"}, {}, 400,
         {"message": "Invalid password."}, equals, 1],
        ["post", authentication_url + "/register_customer", set_up_pass_function, {},
         {"forename": "John", "surname": "Doe", "email": "onlymoney@gmail.com", "password": "Aaaaaaaa1"}, {}, 400,
         {"message": "Email already exists."}, equals, 1],

        # Tests 18 - 34 
        # These tests evaluate all possible errors that can occure when processing register requests 
        ["post", authentication_url + "/register_courier", set_up_pass_function, {}, {}, {}, 400,
         {"message": "Field forename is missing."}, equals, 1],
        ["post", authentication_url + "/register_courier", set_up_pass_function, {}, {"forename": ""}, {}, 400,
         {"message": "Field forename is missing."}, equals, 1],
        ["post", authentication_url + "/register_courier", set_up_pass_function, {}, {"forename": " "}, {}, 400,
         {"message": "Field surname is missing."}, equals, 1],
        ["post", authentication_url + "/register_courier", set_up_pass_function, {}, {"forename": " ", "surname": ""},
         {}, 400, {"message": "Field surname is missing."}, equals, 1],
        ["post", authentication_url + "/register_courier", set_up_pass_function, {}, {"forename": " ", "surname": " "},
         {}, 400, {"message": "Field email is missing."}, equals, 1],
        ["post", authentication_url + "/register_courier", set_up_pass_function, {},
         {"forename": " ", "surname": " ", "email": ""}, {}, 400, {"message": "Field email is missing."}, equals, 1],
        ["post", authentication_url + "/register_courier", set_up_pass_function, {},
         {"forename": " ", "surname": " ", "email": " "}, {}, 400, {"message": "Field password is missing."}, equals,
         1],
        ...
        ["post", authentication_url + "/login", set_up_pass_function, {}, {}, {}, 400,
         {"message": "Field email is missing."}, equals, 1],
        ["post", authentication_url + "/login", set_up_pass_function, {}, {"email": ""}, {}, 400,
         {"message": "Field email is missing."}, equals, 1],
        ["post", authentication_url + "/login", set_up_pass_function, {}, {"email": " "}, {}, 400,
         {"message": "Field password is missing."}, equals, 1],
        ["post", authentication_url + "/login", set_up_pass_function, {}, {"email": " ", "password": ""}, {}, 400,
         {"message": "Field password is missing."}, equals, 1],
        ["post", authentication_url + "/login", set_up_pass_function, {}, {"email": "john", "password": " "}, {}, 400,
         {"message": "Invalid email."}, equals, 1],
        ["post", authentication_url + "/login", set_up_pass_function, {}, {"email": "john@", "password": " "}, {}, 400,
         {"message": "Invalid email."}, equals, 1],
        ["post", authentication_url + "/login", set_up_pass_function, {}, {"email": "john@gmail", "password": " "}, {},
         400, {"message": "Invalid email."}, equals, 1],
        ["post", authentication_url + "/login", set_up_pass_function, {}, {"email": "john@gmail.", "password": " "}, {},
         400, {"message": "Invalid email."}, equals, 1],
        ["post", authentication_url + "/login", set_up_pass_function, {}, {"email": "john@gmail.a", "password": " "},
         {}, 400, {"message": "Invalid email."}, equals, 1],
        ["post", authentication_url + "/login", set_up_pass_function, {},
         {"email": "john@gmail.com", "password": "123"}, {}, 400, {"message": "Invalid credentials."}, equals, 1],
        ["post", authentication_url + "/login", set_up_pass_function, {},
         {"email": get_user(True)["email"], "password": get_user(True)["password"]}, {}, 400,
         {"message": "Invalid credentials."}, equals, 1],
        ["post", authentication_url + "/login", set_up_pass_function, {},
         {"email": get_user(False)["email"], "password": get_user(False)["password"]}, {}, 400,
         {"message": "Invalid credentials."}, equals, 1],

        # Test 47
        # These tests evaluate all possible errors that can occure when processing delete requests 
        ["post", authentication_url + "/delete", set_up_pass_function, {}, {}, {}, 401,
        ...
        ["post", authentication_url + "/register_courier", set_up_pass_function, {}, get_user(False), {}, 200, None,
         user_register_equals(False), 3],
        ["post", authentication_url + "/register_customer", set_up_pass_function, {}, get_user(True), {}, 200, None,
         user_register_equals(True), 3],

        # Test 50
        # These tests evaluate responses in case of susccessfull login of the owner
        ["post", authentication_url + "/login", set_up_pass_function, {},
         {"email": "onlymoney@gmail.com", "password": "evenmoremoney"}, {}, 200, {},
         owner_access_token_test(jwt_secret, roles_field, owner_role), 3],

        # Tests 51 - 52
        # These tests evaluate responses in case of susccessfull login of a customer and courier
        ["post", authentication_url + "/login", set_up_pass_function, {},
         {"email": get_user(True)["email"], "password": get_user(True)["password"]}, {}, 200, {},
         user_access_token_test(True, jwt_secret, roles_field, customer_role), 7],
        ["post", authentication_url + "/login", set_up_pass_function, {},
         {"email": get_user(False)["email"], "password": get_user(False)["password"]}, {}, 200, {},
         user_access_token_test(False, jwt_secret, roles_field, courier_role), 7],

        # Test 53 - 54
        # These tests evaluate responses in case of susccessfull deletion of a customer and courier
        ["post", authentication_url + "/delete", set_up_delete_test(True, False, authentication_url, tokens), {}, {},
         {}, 200, None, user_delete_equals(False), 2],
        ["post", authentication_url + "/delete", set_up_delete_test(True, True, authentication_url, tokens), {}, {}, {},
         200, None, user_delete_equals(True), 2],

        # Test 55 - 56
        # These tests evaluate responses in case of login request using credentials of a deleted account
        ["post", authentication_url + "/login", set_up_pass_function, {},
         {"email": get_user(True)["email"], "password": get_user(True)["password"]}, {}, 400,
         {"message": "Invalid credentials."}, equals, 3],
        ["post", authentication_url + "/login", set_up_pass_function, {},
         {"email": get_user(False)["email"], "password": get_user(False)["password"]}, {}, 400,
         {"message": "Invalid credentials."}, equals, 3],
        ...
        ["post", authentication_url + "/delete", set_up_delete_error_test(True, tokens, 0), {}, {}, {}, 400,
         {"message": "Unknown user."}, equals, 2],
        ["post", authentication_url + "/delete", set_up_delete_error_test(True, tokens, 1), {}, {}, {}, 400,
         {"message": "Unknown user."}, equals, 2],
    ]
